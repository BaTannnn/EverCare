...
export const endpoints = {
  ...
  "receptionist-support-conversations": "/secure/receptionist/support/conversations",
  "receptionist-support-conversation-accept": (id) => `/secure/receptionist/support/conversations/${id}/accept`,
