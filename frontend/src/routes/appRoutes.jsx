...
const receptionistRoles = ["RECEPTIONIST", "ROLE_RECEPTIONIST", "CASHIER", "ROLE_CASHIER", "ADMIN", "ROLE_ADMIN"];
const staffRoles = ["LAB_TECH", "ROLE_LAB_TECH", "MANAGER", "ROLE_MANAGER"];
...
export function renderAppRoutes() {
  return (
    <>
      ...
      <Route element={<ProtectedRoute roles={patientRoles} />}>
      ...
      <Route element={<ProtectedRoute roles={doctorRoles} />}>
      ...
      <Route element={<ProtectedRoute roles={pharmacistRoles} />}>
      ...
      <Route element={<ProtectedRoute roles={receptionistRoles} />}>
